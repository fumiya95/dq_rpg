...
def battle(player, enemy):
    ...
    while player.is_alive() and enemy.is_alive():
        ...
        elif choice == "3":  # サンダーストーム（強攻撃、命中率50%）
            if random.random() < 0.5:
...
# 【ステップ13】 最終統合版（敵選択、技選択、逃走、経験値、レベルアップ）
def main():
